...
const Navbar = () => {
    ...
    return (
        <div className='text-white/70 pt-6'>
                    ...
                    <li>
                        <a href="#contact" className='group'>
                            ...
                            <div className='relative'>
                                ...
                                <div className='mt-1 absolute w-2/3 h-1 transition-all duration-300 ease-out bg-orange-600 rounded-full group-hover:w-full' />
                            </div>
                        </a>
                    </li>
                </ul>
            ...
            <div onClick={toggleNav} className='md:hidden absolute right-5 top-5 rounded border border-white/70 p-2 z-50 text-white/70'>
                {
